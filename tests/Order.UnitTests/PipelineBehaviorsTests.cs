...
public class ExceptionTests
{
    ...
    {
        var ex = new Order.Application.Common.Exceptions.ValidationException();
    ...
    {
        var ex1 = new Order.Application.Common.Exceptions.NotFoundException();
        ex1.Message.ShouldNotBeNull();

        var ex2 = new Order.Application.Common.Exceptions.NotFoundException("message");
        ex2.Message.ShouldBe("message");

        var inner = new Exception("inner");
        var ex3 = new Order.Application.Common.Exceptions.NotFoundException("message", inner);
        ex3.InnerException.ShouldBe(inner);

        var ex4 = new Order.Application.Common.Exceptions.NotFoundException("Entity", 123);
...
public class PipelineBehaviorsTests
{
    ...
    public async Task ValidationBehavior_Should_Throw_ValidationException_When_Validation_Fails()
    {
        ...
        await Should.ThrowAsync<Order.Application.Common.Exceptions.ValidationException>(async () =>
